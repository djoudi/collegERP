<div class="header-top">
    ...
    <div class="header-wrapper">
        ...
        <a href="#" class="utopia-logo"><img src="<?php echo sfConfig::get('app_host') ?>/images/logo.png" alt="Utopia"></a>
        ...
        <div class="header-right">
            ...
            <div class="search-panel header-divider">
                <div class="search-box">
                    <img src="<?php echo sfConfig::get('app_host') ?>/images/zoom.png" alt="Search" style="display: inline; ">
            ...
            <div class="user-panel header-divider">
                <div class="user-info">
                    <img src="<?php echo sfConfig::get('app_host') ?>/images/user.png" alt="">
                    <a href="#">Admin user</a>
                </div>
