...
/**
 * student_fields form base class.
 *
 * @method student_fields getObject() Returns the current form's model object
 *
 * @package    ubeo
 * @subpackage form
 ...
 */
abstract class Basestudent_fieldsForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('student_fields[%s]');
