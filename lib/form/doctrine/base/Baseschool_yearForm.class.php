...
/**
 * school_year form base class.
 *
 * @method school_year getObject() Returns the current form's model object
 *
 * @package    ubeo
 * @subpackage form
 ...
 */
abstract class Baseschool_yearForm extends BaseFormDoctrine
{
