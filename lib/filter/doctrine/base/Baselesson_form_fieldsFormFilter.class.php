...
/**
 * lesson_form_fields filter form base class.
 *
 * @package    ubeo
 * @subpackage filter
 ...
 */
abstract class Baselesson_form_fieldsFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('lesson_form_fields_filters[%s]');
