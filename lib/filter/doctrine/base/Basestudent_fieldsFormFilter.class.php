...
/**
 * student_fields filter form base class.
 *
 * @package    ubeo
 * @subpackage filter
 ...
 */
abstract class Basestudent_fieldsFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('student_fields_filters[%s]');
