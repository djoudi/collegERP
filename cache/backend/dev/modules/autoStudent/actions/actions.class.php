 ...
 */
abstract class autoStudentActions extends sfActions
{
  ...
  public function executeBatch(sfWebRequest $request)
  {
    ...
    $validator = new sfValidatorDoctrineChoice(array('multiple' => true, 'model' => 'student'));
    try
    {
      // validate ids
  ...
  {
    return Doctrine_Core::getTable('student')->hasColumn($column);
  }
}
